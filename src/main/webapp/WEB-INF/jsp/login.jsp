			...
			<form action="/authenticate" method="POST" style="max-width: 600px; margin: 0 auto; " modelAttribute="newlogin" >
				<div class="m-3">
					<div class="form-group row">
						...
						<div class="col-6">
							<input type="text" class="form-control" value="jeet" required="required" name="username"/>
						</div>
					</div>
					<div class="form-group row">
						<label path="password"  class="col-form-label col-4">Password</label>
						<div class="col-6">
							<input required="required" type="password" value="jeet" class="form-control" name="password"
